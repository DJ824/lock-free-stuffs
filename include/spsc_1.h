...
class LockFreeQueue1 {
    ...
    static_assert(std::is_trivially_copyable_v<T>,
                  "LockFreeQueue1 requires trivially copyable T");
    static_assert(std::is_trivially_default_constructible_v<T>,
                  "LockFreeQueue1 direct-slot path requires trivially default-constructible T");
...
public:
    explicit LockFreeQueue1() = default;

    LockFreeQueue1(const LockFreeQueue1&) = delete;
    LockFreeQueue1& operator=(const LockFreeQueue1&) = delete;
