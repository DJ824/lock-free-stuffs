...
class LockFreeQueueStage3 {
    static_assert((SIZE & (SIZE - 1)) == 0, "size must be power of 2");
    static_assert(std::is_trivially_copyable_v<T>,
                  "LockFreeQueueStage3 requires trivially copyable T");
    static_assert(std::is_trivially_default_constructible_v<T>,
                  "LockFreeQueueStage3 direct-slot path requires trivially default-constructible T");
...
public:
    explicit LockFreeQueueStage3() = default;

    LockFreeQueueStage3(const LockFreeQueueStage3&) = delete;
    LockFreeQueueStage3& operator=(const LockFreeQueueStage3&) = delete;
