...
class LockFreeQueueStage4 {
    static_assert((SIZE & (SIZE - 1)) == 0, "size must be power of 2");
    static_assert(std::is_trivially_copyable_v<T>,
                  "LockFreeQueueStage4 requires trivially copyable T");
    static_assert(std::is_trivially_default_constructible_v<T>,
                  "LockFreeQueueStage4 direct-slot path requires trivially default-constructible T");
...
public:
    explicit LockFreeQueueStage4() = default;

    LockFreeQueueStage4(const LockFreeQueueStage4&) = delete;
    LockFreeQueueStage4& operator=(const LockFreeQueueStage4&) = delete;
